...
\begin{frame}
	\frametitle{Literatura}
		\begin{enumerate}
		\item ShareLatex tutorial. [Online]. Dostupno na:
		\url{https://www.sharelatex.com/learn/TikZ_package}
		\item Latex wiki. [Online]. Dostupno na:
		\url {https://en.wikibooks.org/wiki/LaTeX/PGF/TikZ}
		\item Latex tutorial. [Online]. Dostupno na:
		\url {https://www.latex-tutorial.com/tutorials/tikz/}
		\item TikZ/PGF manual. [Online]. Dostupno na:
		\url{http://mirror.utexas.edu/ctan/graphics/pgf/base/doc/pgfmanual.pdf}
		\end{enumerate}
\end{frame}
